...
BEGIN
  ...
  INSERT INTO public.daily_reports (
    ...
    (p_report->>'hifz_surah')::int,
    (p_report->>'hifz_from_ayah')::int,
    (p_report->>'hifz_to_ayah')::int,
  ...
  DO UPDATE SET
    ...
    hifz_surah = EXCLUDED.hifz_surah,
    hifz_from_ayah = EXCLUDED.hifz_from_ayah,
