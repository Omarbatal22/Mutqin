// Canonical surah metadata for the Hafs / Madani mushaf.
// Ayah counts are fixed constants (Σ = 6236). Do not "fix" these without a source.
// Used by the daily report to validate ayah ranges and by the memorization setup.
